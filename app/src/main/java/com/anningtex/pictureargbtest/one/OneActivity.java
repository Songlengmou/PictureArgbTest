...
public class OneActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        adapter = new OneAdapter(R.layout.item_one, mStringList);
        mRecycleView.setLayoutManager(new GridLayoutManager(this, 3));
        mRecycleView.setAdapter(adapter);
    }

    public void getPixColor() {
        mSrc = BitmapFactory.decodeResource(getResources(), R.drawable.pic);
        mHeight = mSrc.getHeight();
        mWidth = mSrc.getWidth();
        Log.e("666_OneActivity", mStringList.toString());
        runnable.run();
